...
import io.hydrosphere.mist.master.namespace.{LocalWorkerRunner, WorkersManager}
...
object Master extends App with Logger {
  ...
  val workersManager2 = system.actorOf(WorkersManager.props(workerRunner), "workers-manager")
