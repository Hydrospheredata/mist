...
private[mist] trait ModelMetadataJsonSerialization extends AnyJsonFormatSupport {
  ...
  implicit val stageMetadataSerialization: RootJsonFormat[Metadata] = jsonFormat(Metadata.apply, "class", "timestamp", "sparkVersion", "uid", "paramMap", "numFeatures", "numClasses", "numTrees")
