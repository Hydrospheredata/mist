...
/**
  * Copied from https://github.com/hseeberger/akka-http-json/
  * There is no akka-http-json builds for 2.10
  */
...
import io.circe.{Decoder, Encoder, Errors, Json, Printer, jawn}
